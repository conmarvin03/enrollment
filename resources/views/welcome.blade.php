                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        <div class="flex size-12 shrink-0 items-center justify-center rounded-full">
                                            <i class="fa-solid fa-book fa-2xl"></i>  </div>

                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-success">Our Mission Is To Power The Future</h2>
                            ...
                            <div class="flex size-12 shrink-0 items-center justify-center rounded-full text-dark">    
                                <i class="fa-solid fa-atom fa-2xl"></i>
                            </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-success">KNOWLEDGE</h2>
                            ...
                            <a
                                   class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10"
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center text-dark text-bold ">
                                    <i class="fa-regular fa-user fa-2xl"></i>      </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-success">LEADERSHIP</h2>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                <div class="flex size-12 shrink-0 items-center justify-center text-dark">
                                    <i class="fa-solid fa-hand-fist fa-2xl"></i>  
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-success">DEDICATION</h2>
